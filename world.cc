...
World::World(Game &g) : GameState{g}, player{std::make_unique<Player>()}, b{"bg.png", g.getOptions()} {
    ...
    setKeymap({
        ...
        { {sf::Keyboard::LShift, sf::Keyboard::A}, {}, std::make_shared<Commands::Player::MoveLeft>(*this, *player, focus_vel-player_vel)},
        { {sf::Keyboard::LShift, sf::Keyboard::D}, {}, std::make_shared<Commands::Player::MoveRight>(*this, *player, focus_vel-player_vel)},
        { {sf::Keyboard::LShift, sf::Keyboard::W}, {}, std::make_shared<Commands::Player::MoveUp>(*this, *player, focus_vel-player_vel)},
        { {sf::Keyboard::LShift, sf::Keyboard::S}, {}, std::make_shared<Commands::Player::MoveDown>(*this, *player, focus_vel-player_vel)},
